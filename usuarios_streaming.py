...
# Caminhos do S3/MinIO para um arquivo chamado usuarios.csv
key_usuarios = "usuarios/diferencial/usuarios.csv"

# O try Catch abaixo checa se já existe um usuarios.csv no bucket
...
for message in consumer:
    ...
    message_df = pd.DataFrame(data=message, index=['id']) # Convertendo a mensagem para um dataFrame
    print(message_df)

    # Converte a mensagem que esta em JSON para DataFrame
